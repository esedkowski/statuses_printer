...
cur.execute('PRAGMA foreign_keys = ON') # turn on foregin keys (probably)
...
# cur.execute('CREATE TABLE referencedMount (referencedAssigmentID INTEGER NOT NULL PRIMARY KEY AUTOINCREMENT, componentRefrencesID FOREGIN KEY REFERENCES componentRefrences(componentRefrencesID), assigmentID FOREGINKEY REFERENCES assigment(assigmentID)')
